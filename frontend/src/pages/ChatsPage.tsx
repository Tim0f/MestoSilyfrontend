...
export default function ChatsPage(): JSX.Element {
  ...
  return (
    <div className="h-dvh bg-customblack text-customwhite flex flex-col pb-[100px] sm:pb-0 pt-4 md:pt-16">
      <div className="flex-1 bg-transparent rounded-xl overflow-hidden shadow-lg m-4 md:m-0">
        <div className="flex h-full">
          ...
          >
            <div className="px-4 mt-6 md:px-6 py-4 md:py-6">
          ...
          <div
            className={`${
              !showChatList ? "flex pt-6 md:flex md:pt-0" : "hidden md:flex"
            } flex-1 flex-col bg-customblack`}
          >
            {/* Шапка */}
            <div className="px-4 md:px-6 py-3 md:py-4 flex items-center justify-between border-b border-customyellow/20 flex-shrink-0">
            ...
            {/* Поле ввода */}
            <div className="px-4 md:px-8 py-4 md:py-6 border-t border-customyellow/20 flex-shrink-0">
