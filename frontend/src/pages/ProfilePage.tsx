...
export default function ProfilePage() {
  ...
  return (
    <div className="text-white bg-customblack min-h-screen mt-14 md:mt-12 p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div className="flex items-center justify-center flex-col">
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-4 md:mt-6 relative items-center">
          ...
          <button
            ...
            className="bg-customyellow text-black font-h2 px-6 py-2 rounded-xl hover:brightness-90 w-full md:w-auto"
          >
            Получить достижение
          </button>
        ...
        {filteredAchievements.map((a, i) => (
          <div key={i} className="flex flex-col md:flex-row items-center justify-between bg-customblack border border-[#403B36] rounded-2xl px-4 md:px-6 py-4 relative gap-4">
            ...
            <div className="flex items-center gap-3 md:gap-4 w-full md:w-auto justify-center md:justify-end">
              {a.isActive ? (
                <button className="bg-customyellow text-black font-h2 px-5 py-2 rounded-xl shadow hover:brightness-90 text-sm">получить</button>
              ) : (
