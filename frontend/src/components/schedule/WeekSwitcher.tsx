      ...
      <div className="flex items-center gap-[10px] md:gap-[20px]">
        ...
        >
          <Border3 className="w-full h-full fill-customyellow stroke-customyellow flex justify-center items-center hover:scale-[1.03] transition">
            <span className="text-[22px] md:text-[28px] font-h1 text-black leading-none">
              {subscriptionCount}
            </span>
          </Border3>
        </button>
          ...
          {weekDates.map((date, i) => {
            ...
            return (
              <button
                ...
                className="w-[70px] h-[70px] md:w-[95px] md:h-[85px] flex flex-col justify-center items-center"
              >
                <Border2
                  className={`${
                    isActive
                ...
                >
                  <span className="text-[20px] md:text-[26px] font-h1 text-black leading-none">
                    {date.getDate()}
                  </span>
                  <span className="text-[12px] md:text-[15px] mt-[1px] md:mt-[3px] uppercase">
                    {dayName}
                  </span>
                </Border2>
              </button>
